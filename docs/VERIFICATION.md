...
- Claude Code: `2.1.278`
- Ran: 2026-09-21T23:07:19.056Z → 2026-09-21T23:21:41.753Z
- Took: 863s
...
- diagnostic: Every expected slot must pass; fail, blocked and unknown outcomes are not passes.
- provenance start: commit: 3b42a61af1d461f3aa6c9bcc807fcb7afdfdd4e1; dirty: true; fingerprint: sha256 verification-code-v1 0101162ad82ba5f80f123368628f64a325b17dc79eb9ef47897385e9dd2b0f6e; files: 41
- provenance end: commit: 3b42a61af1d461f3aa6c9bcc807fcb7afdfdd4e1; dirty: true; fingerprint: sha256 verification-code-v1 0101162ad82ba5f80f123368628f64a325b17dc79eb9ef47897385e9dd2b0f6e; files: 41
...
| `--model-concurrency` | 7 | Concurrent model workers |
...
**pass 74 / fail 2 / blocked 1** — 77 slots, gate 77.
...
```bash
PENDING_TOOL_WAIT_MS=30000 npm run verify -- --timeout-scale 2 --model-concurrency 7 --scenario-concurrency 2 # 7 models × 11 scenarios
PENDING_TOOL_WAIT_MS=30000 npm run verify -- --timeout-scale 2 --model-concurrency 7 --scenario-concurrency 2 --dry-run # plan only, no model calls
