...
- Claude Code: `2.1.278`
- Ran: 2026-09-21T09:45:17.604Z → 2026-09-21T09:53:36.122Z
- Took: 499s
...
**pass 74 / fail 3 / blocked 0** — 77 slots, gate 74.
...
The 11 scenarios exercise **92.2%** of the Claude Code core-feature inventory (weight 94/102). That number is computed from the inventory in `scripts/verify/features.mjs` and each scenario's `covers` list, not asserted in prose.
